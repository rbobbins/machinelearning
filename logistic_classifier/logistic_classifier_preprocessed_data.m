function logistic_classifier()
    ...
    load('../preprocessed_training')
    data = training_data;
    y_train = data(1:30000,1);
    % y_cross = data(22501:end, 1);
    
    X_train = data(1:30000, 2:end);
    ...
    A = sigmoid(all_theta * X_test');
    [p, ip] = max(A);

    csvwrite('logistic_multiclass_results_preprocessed_data.csv', ip')
end
